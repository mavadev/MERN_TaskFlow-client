...
const SettingsAuthentication = () => {
	...
	return (
		<main className='flex-1 p-5 overflow-auto bg-white'>
			<h2 className='text-xl font-semibold border-b border-gray-300 pb-2 mb-5'>Autenticación</h2>
			<form
				noValidate
				onSubmit={handleSubmit(handleChangePassword)}
				className='space-y-8 bg-white w-full max-w-md text-left'>
				...
				<input
					...
					className='bg-primary-600 hover:bg-primary-700 w-full p-3 text-white font-black text-lg cursor-pointer'
				/>
			</form>
		</main>
	);
